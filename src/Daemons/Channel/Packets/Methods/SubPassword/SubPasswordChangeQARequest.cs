...
namespace Minerva
{
    ...
    {
        public static void SubPasswordChangeQARequest(PacketReader packet, PacketBuilder builder, ClientHandler client, EventHandler events)
        {
            packet.Skip(4);
            ...
            client.Send(builder, "SubPasswordChangeQARequest");
